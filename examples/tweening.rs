...
fn main() {
    App::new()
        ...
        .add_systems(
            Update,
            component_animator_system::<PixelPerfectCamera>
...
fn setup(
    ...
    let open_little = Tween::new(
        ...
        BarsLens {
            start_offset: Vec2::splat(128.0),
            end_offset: Vec2::new(48.0, 112.0),
            pixelated: true,
        },
    );
    ...
    let open_full = Tween::new(
        ...
        BarsLens {
            start_offset: Vec2::new(48.0, 112.0),
            end_offset: Vec2::ZERO,
            pixelated: true,
        },
    );
